...
function sskadmin(e) {
	var ssk = '';
	if(e.user_id==4369123){
		ssk = '<span class="sskadmin">站方回复'
	}
	return ssk+"</span> ";
}
//管理员判断结束
...
function ua(e) {
		...
		if (r = e.match(/FireFox\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<span class="ua_firefox"><i class="fa fa-firefox"></i> FireFox ' + '|' + r1[1]
				//--------------------------------------------------------------------------------------------
		} else if (r = e.match(/TheWorld([\d]*)\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<span class="ua_maxthon"><i class="fa fa-globe"></i> 世界之窗'
			//---------------------------------------------------------------------------------------------
       // } else if (r = e.match(/360ee([\d]*)\/([^\s]+)/ig)) {
			//var r1 = r[0].split("/");
			//outputer = '<span class="ua_360browser"><i class="fa fa-globe"></i> 360浏览器'
			//---------------------------------------------------------------------------------------------
		...
		} else if (r = e.match(/baidubrowser([\d]*)\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> 百度浏览器' + '|' + r1[1]
		} else if (r = e.match(/UBrowser([\d]*)\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> UC浏览器' + '|' + r1[1]
			...
			outputer = '<span class="ua_2345explorer"><i class="fa fa-globe"></i> 2345浏览器</a>'
		} else if (r = e.match(/2345chrome/ig)) {
			outputer = '<span class="ua_2345chrome"><i class="fa fa-globe"></i> 2345浏览器</a>'
		} else if (r = e.match(/LBBROWSER/ig)) {
			outputer = '<span class="ua_lbbrowser"><i class="fa fa-globe"></i> 猎豹浏览器'
		} else if (r = e.match(/MicroMessenger\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<span class="ua_qq"><i class="fa fa-weixin"></i> 微信内置' + '|' + r1[1]/*.split('/')[0]*/
			...
			outputer = '<span class="ua_ie"><i class="fa fa-internet-explorer"></i> IE' + '|' + r[0]/*.replace('MSIE', '').split('.')[0]*/
		} else {
			outputer = '<span class="ua_other"><i class="fa fa-globe"></i> 其他浏览器'
		}
	...
	function os(e) {
		...
		if (e.match(/win/ig)) {
			...
			os = '<span class="os_mac"><i class="fa fa-apple"></i> iOS/OS X'
		} else if (e.match(/unix/ig)) {
			os = '<span class="os_unix"><i class="fa fa-desktop"></i> Unix'
		} else if (e.match(/symbian/ig)) {
			os = '<span class="os_nokia"><i class="fa fa-nokia"></i> Nokia SymbianOS'
		} else {
			os = '<span class="os_other"><i class="fa fa-desktop"></i> Other OS'
		}
		return os+"</span>" ;
	}
//显UA结束
